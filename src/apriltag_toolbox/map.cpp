...
Map::Map(ros::NodeHandle &nh) : tfBuffer(ros::Duration(30.0)) {
    ...
    cameraPosePub = ros::Publisher(
        nh.advertise<geometry_msgs::PoseWithCovarianceStamped>("/apriltag_toolbox/camera_pose", 1));
...
bool Map::addFiducialCallback(apriltag_toolbox::AddFiducial::Request &req,
                              apriltag_toolbox::AddFiducial::Response &res)
{
